module.exports = {
  Admins: ["567177086041587712"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "as!", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/sbySMS7m3v", //Support Server Link
  Token: process.env.Token || "ODU4MTgyMjUzMjQ5OTUzODI0.YNaagQ.lbCGV0oUNAfi631y7_CWWKJcLGE", //Discord Bot Token
  ...
  CookieSecret: "Astolfo mi dios uwu", //A Secret like a password
  IconURL:
